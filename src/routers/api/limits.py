...
async def get_limit_detail(pk: int, limit_service: Annotated[LimitService, Depends(get_limit_service)]) -> LimitDetail:
    """Детали лимита."""
...
async def delete_limit(pk: int, limit_service: Annotated[LimitService, Depends(get_limit_service)]) -> None:
    """Удалить лимит."""
